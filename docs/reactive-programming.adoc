...
:page-url: https://decks.ruaux.org/reactive-programming.html
...
[NOTE.speaker]
--
* Publisher (water source) → Pipe → Subscriber (fire)
...
[%step]
* *2009:* Rx.NET (Microsoft, Erik Meijer)
* *2013:* Reactive Manifesto
* *2014:* Reactive Streams (JVM spec)
...
* Redis Cache: https://github.com/redis-field-engineering/redis-cache-java[github.com/redis-field-engineering/redis-cache-java]
* This presentation: https://decks.ruaux.org/reactive-programming.html[decks.ruaux.org/reactive-programming.html]
--
