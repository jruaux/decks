...
The system should be designed in a way that supports any target Redis data structure (hashes, strings, JSON, etc.).
...
* Multithreading and job management (consider in-memory queues).
...
- _Expected Answers_:
  * Separation of concerns between the reader, processors, and writer.
